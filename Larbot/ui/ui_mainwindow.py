...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.player_list = QtGui.QListWidget(self.widget_13)
        self.player_list.setMinimumSize(QtCore.QSize(200, 0))
        self.player_list.setMaximumSize(QtCore.QSize(200, 16777215))
        self.player_list.setEditTriggers(QtGui.QAbstractItemView.NoEditTriggers)
        self.player_list.setAlternatingRowColors(True)
        self.player_list.setSelectionMode(QtGui.QAbstractItemView.MultiSelection)
        ...
        self.verticalLayout_3 = QtGui.QVBoxLayout(self.widget_14)
        self.verticalLayout_3.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_3.setObjectName("verticalLayout_3")
        spacerItem10 = QtGui.QSpacerItem(20, 40, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
        self.verticalLayout_3.addItem(spacerItem10)
        self.remove_button = QtGui.QPushButton(self.widget_14)
        self.remove_button.setObjectName("remove_button")
        self.verticalLayout_3.addWidget(self.remove_button)
        self.swap_button = QtGui.QPushButton(self.widget_14)
        self.swap_button.setObjectName("swap_button")
        self.verticalLayout_3.addWidget(self.swap_button)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.remove_button.setText(QtGui.QApplication.translate("MainWindow", "Remove player(s)", None, QtGui.QApplication.UnicodeUTF8))
